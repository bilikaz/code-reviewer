...
import { baseSystemSections, baseUserSections, llmStageMetric, loadPromptAssets } from "../shared.js";
...
export async function runReconcile(ctx, state) {
    ...
    if (Object.keys(renames).length > 0) {
        ...
        if (relocated > 0)
            comments = await ctx.provider.getPRComments();
    }
