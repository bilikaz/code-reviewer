...
function usageAndExit() {
    process.stderr.write("usage: reviewer <run|fetch|reconcile|review|summarize> --pr <url|local://[base]> [--llm-url <u>] [--llm-key <k>] [--llm-model <m>]\n");
    process.exit(2);
}
function die(msg) {
